...
if (isset($_GET["id"])) {
    ...
    $query = "SELECT * FROM msoffice WHERE ms_id = '$id'";
...
if (isset($_POST["update"])) {
    ...
    $query = "UPDATE msoffice SET  Password='$Password', SerialNumber='$SerialNumber', `Key`='$Key', Key_from_office='$Key_from_office' WHERE ms_id=$id";
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <form action="" method="post">
                                <input type="hidden" name="id" value="<?php echo $asset['ms_id']; ?>">
                                <div class="form-group">
                                    <label class="font-weight-bold" style="color: black;" for="assets_name">MS Oiffce EMAIL :</label>
                                    <input type="text" name="Email" class="form-control" value="<?php echo $asset['Email']; ?>" disabled>
                                </div>
                                <div class="form-group">
                                    <label class="font-weight-bold" style="color: black;" for="assets_name">Password:</label>
                                    <input type="text" class="form-control" name="Password" value="<?php echo $asset['Password']; ?>">
                                </div>
                                <div class="form-group">
                                    <label class="font-weight-bold" style="color: black;" for="assets_type">Serial number:</label>
                                    <input type="text" class="form-control" name="SerialNumber" value="<?php echo $asset['SerialNumber']; ?>">

                                    
                                </div>
                                <div class="form-group">
                                    <label class="font-weight-bold" style="color: black;" for="assets_model">KEY:</label>
                                    <input type="text" class="form-control" name="Key" value="<?php echo $asset['Key']; ?>">
                                </div>
                                <div class="form-group">
                                    <label class="font-weight-bold" style="color: black;" for="assets_serial">KEY From Office :</label>
                                    <input type="text" class="form-control" name="Key_from_office" value="<?php echo $asset['Key_from_office']; ?>">
                                </div>
                                <div class="form-group">

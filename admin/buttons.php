...
if (isset($_POST['submit'])) {
    ...
    $date = $_POST['date'];
    $resign = isset($_POST['resign']) ? $_POST['resign'] : 'no';


    $check_sql = "SELECT * FROM users_info WHERE userid='$userid' LIMIT 1";
    $result = mysqli_query($conn, $check_sql);
    $assets = mysqli_fetch_assoc($result);
    if ($assets && $assets['userid'] === $userid) {
        echo '
        <script>
    setTimeout(function() {
        swal({
        ...
        $sql = "INSERT INTO users_info (userid, firstname, lastname, depart,division, date, resign) 
        VALUES ( '$userid', '$firstname', '$lastname', '$depart', '$division', '$date', '$resign')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 text-center">Add new Employee</h1>
                        ...
                        <div class="container">
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Firstname" name="firstname" id="firstname" required>
                                </div>
                                <div class="form-group">
                                    <label style="color: black; font-weight:bold;"> Last Name :</label>
                                    <input type="text" class="form-control" placeholder="Enter Lastname" name="lastname" id="lastname" required>
                                </div>
                                <div class="form-group">
                                    <label style="color: black; font-weight:bold;">employee Depart :</label>
                                    <select name="depart" id="depart" class="form-control">
                                        ...
                                        <option value="HR & GA Department">HR & GA Department</option>
                                ...
                                <div class="form-group">
                                    <label style="color: black; font-weight:bold;">Division : </label>
                                    <input type="text" class="form-control" placeholder="Enter Name" name="division" id="division" required oninput="toggleResign()">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label style="color: black; font-weight:bold;">Resign : </label>

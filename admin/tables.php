        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800" style="font-family:'kanit' !important ;">ข้อมูลของคนที่สมัครเว็ป</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="input-group">
                            <input type="text" id="MyInput" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" onkeyup="myFunction()">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    $sql = "SELECT username,firstname,lastname,password,email FROM users";
                                    $result = mysqli_query($conn, $sql);
                                    $row1 = mysqli_fetch_assoc($result);
                                    if ($row1 > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            echo "<tr><td>" . $row["username"] . "</td><td>" . $row["firstname"] . "</td><td>" . $row["lastname"]
                                                . "</td><td>" . $row["password"] . "</td><td>" . $row["email"] . "</tr>";
                                        }
                                        echo "</table>";
                                    } else {
                                        echo "0 results";

                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="resign" id="resign">
                                ...
                                <!-- example join table -->
                                <!-- <div class="form-group">
                                    <label for="resign">assets:</label>
                                    <select name="assets_id" class="form-control">
                                        <?php
                                        $sql = "SELECT a_id, assets_name FROM assets";
                                        $result = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo '<option value="' . $row['id'] . '">' . $row['assets_name'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="assets_id" class="form-control">
                                        <?php
                                        $sql = "SELECT a_id, assets_serial FROM assets";
                                        $result = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo '<option value="' . $row['id'] . '">' . $row['assets_serial'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div> -->
                               
                                <!-- <input type="submit" class="btn btn-danger" style="margin-left: 30px;" value="Delete"> -->
